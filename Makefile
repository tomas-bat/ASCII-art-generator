...
StartController.o: src/StartController.cpp src/Global.hpp \
  src/StartController.hpp src/Controller.hpp src/Command.hpp \
  src/Interface.hpp src/ConverterController.hpp src/Image.hpp \
  src/ImageASCII.hpp src/ImageRGB.hpp src/AnimatorController.hpp \
  src/EditorController.hpp
